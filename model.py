...
enhanced_image = feature_concatenation_model(feature_map_low_light_image, feature_map_reference_image)
...
def decoder(inputs):
    ...
    outputs = Conv2D(1, 1, kernel_initializer="he_normal",activation='softmax')(c9)
    return outputs
